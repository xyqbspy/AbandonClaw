...
export const SCENE_TRAINING_STEPS: Array<{
  ...
  { key: "practice_sentence", title: SCENE_TRAINING_STEP_TITLES.practice_sentence },
...
export const getSceneTrainingStepTitle = (step: TrainingStepKey | null | undefined) =>
  SCENE_TRAINING_STEPS.find((item) => item.key === step)?.title ?? SCENE_TRAINING_STEP_TITLES.listen;
...
export const sceneDetailMessages = {
  ...
  focusExpressionPrompt: "先抓一个重点表达，后面练句子会更顺。",
  ...
  sceneMilestones: {
    ...
    practice_sentence: "场景升级：已经练过核心句了",
