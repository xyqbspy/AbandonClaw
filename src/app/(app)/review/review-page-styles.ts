...
export const REVIEW_PAGE_CLASSNAME =
  "min-h-screen bg-[#f8fafc] px-3 pt-3 pb-28 sm:pt-4 lg:px-5";
...
export const REVIEW_HERO_CLOSE_BUTTON_CLASSNAME =
  "flex h-8 w-8 items-center justify-center rounded-full text-slate-400 transition hover:text-slate-600";

export const REVIEW_HERO_PROGRESS_LABEL_ROW_CLASSNAME =
  "mb-1.5 flex items-center justify-between text-[10px] font-black uppercase tracking-widest text-slate-400";

export const REVIEW_HERO_PROGRESS_TRACK_CLASSNAME =
...
export const REVIEW_SUMMARY_CARD_VALUE_CLASSNAME = "mt-1 text-lg font-black text-slate-900";
...
export const REVIEW_STAGE_PROGRESS_DOT_DONE_CLASSNAME =
  "h-1 w-1 rounded-full bg-blue-300";

export const REVIEW_STAGE_PROGRESS_DOT_CURRENT_CLASSNAME =
...
export const REVIEW_TARGET_META_PILL_CLASSNAME =
...
export const REVIEW_INPUT_OPTION_BUTTON_CLASSNAME =
  "rounded-xl border border-slate-100 bg-white px-4 py-2 text-[11px] font-bold text-slate-500 transition active:scale-[0.98]";

export const REVIEW_INPUT_OPTION_BUTTON_ACTIVE_CLASSNAME =
  "rounded-xl bg-blue-600 px-4 py-2 text-[11px] font-black text-white shadow-md shadow-blue-200 transition active:scale-[0.98]";

export const REVIEW_INPUT_TEXTAREA_CLASSNAME =
...
export const REVIEW_INPUT_ICON_BUTTON_CLASSNAME =
...
export const REVIEW_FEEDBACK_RESULT_COMPLETE_CLASSNAME = "text-emerald-500";
export const REVIEW_FEEDBACK_RESULT_STRUCTURE_CLASSNAME = "text-sky-600";
export const REVIEW_FEEDBACK_RESULT_KEYWORD_CLASSNAME = "text-amber-600";
export const REVIEW_FEEDBACK_RESULT_INCORRECT_CLASSNAME = "text-rose-500";

export const REVIEW_FEEDBACK_PILL_BASE_CLASSNAME =
  "rounded-full px-2.5 py-0.5 text-[10px] font-black uppercase tracking-wide";

export const REVIEW_FEEDBACK_PILL_SUBTLE_CLASSNAME =
  `${REVIEW_FEEDBACK_PILL_BASE_CLASSNAME} bg-slate-100 text-slate-600`;

export const REVIEW_FEEDBACK_PILL_INFO_CLASSNAME =
  `${REVIEW_FEEDBACK_PILL_BASE_CLASSNAME} bg-sky-100 text-sky-700`;

export const REVIEW_FEEDBACK_PILL_WARNING_CLASSNAME =
  `${REVIEW_FEEDBACK_PILL_BASE_CLASSNAME} bg-amber-100 text-amber-700`;

export const REVIEW_FEEDBACK_PILL_SUCCESS_CLASSNAME =
...
export const REVIEW_FOOTER_INNER_CLASSNAME = "mx-auto flex w-full max-w-3xl flex-col gap-2";

export const REVIEW_FOOTER_REVIEW_GRID_CLASSNAME = "grid grid-cols-3 gap-2";

export const REVIEW_FOOTER_HINT_CLASSNAME =
  "rounded-2xl bg-slate-50 px-4 py-3 text-center text-[11px] font-bold text-slate-500";

export const REVIEW_FOOTER_PRIMARY_BUTTON_CLASSNAME = buttonVariants({
  className:
    "h-14 w-full rounded-2xl bg-blue-600 text-sm font-black text-white shadow-xl shadow-blue-200 hover:bg-blue-700 active:scale-[0.98]",
});

export const REVIEW_FOOTER_PRIMARY_FULL_BUTTON_CLASSNAME =
  REVIEW_FOOTER_PRIMARY_BUTTON_CLASSNAME;

export const REVIEW_FOOTER_SECONDARY_BUTTON_CLASSNAME = buttonVariants({
  variant: "secondary",
  className:
    "h-14 w-full rounded-2xl bg-slate-100 text-sm font-black text-slate-700 hover:bg-slate-200 active:scale-[0.98]",
});

export const REVIEW_FOOTER_DANGER_BUTTON_CLASSNAME = buttonVariants({
  variant: "destructive",
  className:
    "h-14 w-full rounded-2xl bg-rose-500 text-sm font-black text-white shadow-xl shadow-rose-200 hover:bg-rose-600 active:scale-[0.98]",
});
