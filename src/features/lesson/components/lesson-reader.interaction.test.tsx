...
function createGettingBackOnTrackLesson(): Lesson {
  return {
    id: "getting-back-on-track",
    slug: "getting-back-on-track",
    title: "Getting Back On Track",
    subtitle: "Restart your learning rhythm",
    difficulty: "Beginner",
    estimatedMinutes: 5,
    completionRate: 0,
    tags: ["routine"],
    ...
    sections: [
      {
        id: "section-1",
        title: "Yesterday",
        summary: "Talk about why you got off track.",
        blocks: [
          {
            id: "block-1",
            kind: "monologue",
            translation: "我昨天睡得挺晚。我一直在刷视频，而不是学英语。",
            sentences: [
              {
                id: "sentence-1",
                ...
                chunkDetails: [
                  {
                    ...
                    translation: "睡得挺晚",
                    grammarLabel: "verb phrase",
                    meaningInSentence: "这里自然地描述前一天睡得比较晚。",
                    usageNote: "很自然地描述前一天作息拖晚了。",
                    examples: [
                      { en: "I went to bed pretty late last night.", zh: "我昨晚睡得挺晚。" },
                    ],
                    start: 2,
                    end: 26,
                  },
                ...
                chunkDetails: [
                  {
                    ...
                    text: "instead of",
                    translation: "而不是",
                    grammarLabel: "preposition phrase",
                    meaningInSentence: "这里用来对比实际做的事和本来该做的事。",
                    usageNote: "用于说明两个选择之间的替代关系。",
                    examples: [
                      { en: "I walked instead of taking a taxi.", zh: "我走路了，而不是打车。" },
                    ],
                    start: 24,
                    end: 34,
                  },
...
test("LessonReader 在移动端点击气泡下方翻译图标和朗读按钮时会按预期工作", () => {
  mockMatchMedia(true);
  const lesson = createDialogueLesson();
  ...
  const translation = within(blockContainer).getByText("我正在努力跟上进度。你很快就会好的。");
  ...
  fireEvent.click(within(blockContainer).getByRole("button", { name: "显示翻译" }));
  assert.match(translationContainer.className, /opacity-100/);

  fireEvent.click(within(blockContainer).getByRole("button", { name: "隐藏翻译" }));
  assert.match(translationContainer.className, /opacity-0/);
