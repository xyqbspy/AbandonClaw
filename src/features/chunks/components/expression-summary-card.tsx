...
const TITLE_CLASS = "text-[clamp(17px,4.8vw,20px)] font-extrabold tracking-[-0.02em] text-[#1A365D] [@media(max-height:760px)]:text-[length:var(--mobile-font-title)]";
const MEANING_CLASS = "mb-4 text-[length:var(--mobile-font-sheet-body)] font-medium text-[#4A5568] [@media(max-height:760px)]:mb-3 [@media(max-height:760px)]:text-[length:var(--mobile-font-body)]";
...
const GROUP_LABEL_CLASS = "text-[length:var(--mobile-font-caption)] font-bold text-[#718096]";
const GROUP_LINK_CLASS = "text-[length:var(--mobile-font-caption)] font-bold text-[#2C8C6E]";
...
const RELATED_PRIMARY_CLASS = "text-[length:var(--mobile-font-body)] font-semibold text-[#1F5E7E] [@media(max-height:760px)]:text-[length:var(--mobile-font-body-sm)]";
const RELATED_SECONDARY_CLASS = "text-[length:var(--mobile-font-body-sm)] text-[#718096] [@media(max-height:760px)]:text-[length:var(--mobile-font-meta)]";
